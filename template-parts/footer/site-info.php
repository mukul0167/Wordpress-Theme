...
<div class="site-info py-4 text-center">
    ...
    printf(
      ...
      '<a target="_blank" href="' . esc_attr__( 'https://www.ovationthemes.com/wordpress/free-academy-wordpress-theme/', 'education-academy-coach' ) . '"> Education WordPress Theme</a>'
    );
    ?></p>
</div>
